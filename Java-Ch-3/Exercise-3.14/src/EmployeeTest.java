...
public class EmployeeTest {
    ...
    Scanner input = new Scanner(System.in);     
        ...
        System.out.println("Enter about of employee1: ");     
        System.out.print("Enter First of employ Name: ");
        firstName = input.next();
        employee1.setFirstName(firstName);
        employee1.getFirstName();
        System.out.print("Enter Last of employ Name: ");
        lastName = input.next();
        ...
        System.out.printf(" after incement of salery "
